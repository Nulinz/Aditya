            ...
            <div class="accordion-item mt-3">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed py-2" type="button" data-bs-toggle="collapse"
                        data-bs-target="#accord11">
                        <h4 class="m-0">Overhead Master</h4>
                    </button>
                </h2>
                <div id="accord11" class="accordion-collapse collapse">
                    <div class="accordion-body maindiv">
                        <div class="container-fluid px-1">
                            <div class="row">
                                <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                    <label for="itemcode">Project <span>*</span></label>
                                    <select class="form-select select2input" name="pro_id" id="designation" required>
                                ...
                                <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                    <label for="itemcode">Overhead Master Code <span>*</span></label>
        ...
        <div class="filter-container row mb-3">
            ...
            <div class="select1 col-sm-12 col-md-4 mx-auto">
                <div class="d-flex gap-3">
                    <a href="{{route('overhead.export')}}" id="export" data-bs-toggle="tooltip" data-bs-title="Export"><i
                            class="fa-solid fa-file-export"></i></a>
                    <a href="" id="import" data-bs-toggle="modal" data-bs-target="#import_headmaster"><i
            ...
            <table class="example table table-hover table-striped">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Project</th>
                        <th>Overhead Master Code</th>
                        <th>Description</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($overhead as $overheads)
                            <tr>
                                <td>{{$loop->iteration}}</td>
                                <td>{{$overheads->pro_title}}</td>
                                <td>{{$overheads->item_code}}</td>
                                <td>{{$overheads->mat_des}}</td>
                                <td>
                                    <div class="d-flex gap-3">

                                        <a href="{{ route('overhead.edit', ['id' => $overheads->id]) }}">
                                            <i class="fa-solid fa-pen-to-square" data-bs-toggle="tooltip" data-bs-title="Edit"></i>
                                        </a>
                                        <a data-remote="{{ route('overhead.destroy', ['id' => $overheads->id]) }}" class="delete-confirm">
...
<!-- Popup -->
<div class="modal fade" id="import_headmaster" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title fs-5" id="exampleModalLabel">Overhead Master Import</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="row" action="{{route('overhead.import')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <h6 class="mb-3 fw-semibold">Sample File - <a href="" download>Download</a></h6>
                    <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                        <label for="file">File</label>
                        <input type="file" class="form-control" name="overhead_file" id="file">
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = '{{route('overhead.index')}}';
                        }, 1000);
